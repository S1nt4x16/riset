...
@section('content')
<div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 max-w-2xl mx-auto" x-data="questionForm()">
    <div class="mb-6">
            ...
            <div>
                ...
                <div x-show="!isNewSection">
                    <div class="flex gap-2">
                        <select name="section" class="w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-teal-500 focus:border-teal-500 bg-white">
                ...
                <div x-show="isNewSection" class="hidden" :class="{ 'hidden': !isNewSection }">
                    <div class="flex gap-2">
                        <input type="text" name="section" x-ref="newSectionInput" class="w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-teal-500 focus:border-teal-500" placeholder="Nama Section Baru...">
    ...
    <script>
        function questionForm() {
            return {
                isNewSection: false,
                type: '{{ old('type', 'radio') }}',
                keyMode: 'none', // none, faculty, prodi_degree, custom
                customKey: '',
                options: [''],
